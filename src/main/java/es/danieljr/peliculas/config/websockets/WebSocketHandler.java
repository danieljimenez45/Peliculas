...
public class WebSocketHandler extends TextWebSocketHandler implements SubProtocolCapable, WebSocketSender {
    ...
    // Sesiones de los clientes conectados, para recorrerlos y enviarles mensajes (patrón observer)
    ...
    public void afterConnectionEstablished(WebSocketSession session) throws Exception {
        ...
        TextMessage message = new TextMessage("Updates Web socket: " + entity + " - (App de Peliculas)");
